...
const Section3 = () => {
  return (
    <section
        id='section3'
            className='relative min-h-[100svh] w-full overflow-hidden bg-black border-b border-white/10 scroll-mt-24 sm:scroll-mt-28 md:scroll-mt-32'
    >
      <div className='mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-14 sm:py-20 md:py-24'>
        <div className='flex flex-col md:flex-row'>
          {/* Left content */}
          <div
            className='w-full md:w-1/2 min-h-[50svh] md:min-h-0 flex flex-col justify-center gap-5 sm:gap-6 md:gap-8'
          >
